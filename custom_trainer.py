...
class Trainer():
	...
	def train_domain_adaptation(self, epochs: int = 25, wait: int = 12, persist_best_model: bool = True):
		...
		for epoch in range(self.epochs):
			...
			self.logger.write_scalar('segmentation_writer', 'learning_rate', lr_1, p)
			self.logger.write_scalar('discriminator_writer', 'learning_rate', lr_2, p)
			self.logger.write_scalar('discriminator_writer', 'lambda', l, p)
			...
			self.logger.write_scalar('train_writer', 'loss_segmentation', loss_segmentation_train, p)
			self.logger.write_scalar('train_writer', 'loss_discriminator', loss_discriminator_train, p)
			self.logger.write_scalar('train_writer', 'accuracy_segmentation', acc_segmentation_train, p)
			self.logger.write_scalar('train_writer', 'accuracy_discriminator', acc_discriminator_train, p)
			...
			self.logger.write_scalar('val_writer', 'loss_segmentation', loss_segmentation_val, p)
			self.logger.write_scalar('val_writer', 'loss_discriminator', loss_discriminator_val, p)
			self.logger.write_scalar('val_writer', 'accuracy_segmentation', acc_segmentation_val, p)
			self.logger.write_scalar('val_writer', 'accuracy_discriminator', acc_discriminator_val, p)	
	...
	def train(self, epochs: int = 25, wait: int = 12, persist_best_model: bool = True):
		...
		for epoch in range(self.epochs):
			...
			self.logger.write_scalar('segmentation_writer', 'learning_rate', lr, p)
			...
			self.logger.write_scalar('train_writer', 'loss_segmentation', loss_global_train, p)
			self.logger.write_scalar('train_writer', 'accuracy_segmentation', acc_global_train, p)
			...
			self.logger.write_scalar('val_writer', 'loss_segmentation', loss_global_val, p)
			self.logger.write_scalar('val_writer', 'accuracy_segmentation', acc_global_val, p)
