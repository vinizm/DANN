...
def Deeplabv3plus(weights=None, input_tensor=None, input_shape=(512, 512, 3), classes=21, backbone='xception',
    ...
    if backbone == 'xception':
        ...
        #skip0 - tensor(256,256) para upsample de 4 repartido de 2 em 2
    ...
    if backbone == 'xception':
        ...
        x = SepConv_BN(x, 256, 'decoder_conv2',
                       depth_activation=True, epsilon=1e-5)
        x = SepConv_BN(x, 256, 'decoder_conv3',
                       depth_activation=True, epsilon=1e-5)


        x = Lambda(lambda xx: tf.compat.v1.image.resize(xx,
                                                        size_before2[1:3] * tf.constant(OS // 2),
                                                        method='bilinear', align_corners=True))(x)


        dec_skip0 = Conv2D(48, (1, 1), padding='same',
                           use_bias=False, name='feature_projection0')(skip0)
